...
<div style="float:left;">
    <table border="1" style="float:left; width:670px; font-size:14px;">
        <tr>
            <th scope="col" style="padding:10px;width:400px;">Product</th>
        ...
        <tr>
            ...
            <td valign="top" style="text-align:center;; vertical-align:middle; line-height:20px;">
                <div>
                    ...
                    <p><b>Price/Item : &pound;</b> <span><?php echo $item["price"]; ?></span></p>
                    <p><b>Bill : &pound;</b> <span><?php echo $item["bill"]; ?></span></p>
                </div>
            </td>
    ...
    <br/>  <h2 style="float:left;"><strong>&nbsp;&nbsp; &nbsp;TOTAL BILL : </strong>&pound; <?php  if(isset($bill_total)) echo $bill_total;?></h2>
    </div> 
    ...
    { ?>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                    ...
                    <p style="float:left;"><button type="submit" class="continue" name="submit">Confirm Invoice</button></p>
...
{ ?>
    <div>
        ...
        <a href="generatePdf.php" style="float:left;" class=""><button class="continue">Print Invoice</button></a>
        </p>
        <br/>          
    </div>
